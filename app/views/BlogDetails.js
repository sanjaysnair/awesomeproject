...
export class BlogDetails extends React.Component {
    ...
    componentDidMount() {
        blogId = this.props.navigation.getParam('blogId', 'NO BLOG');
        return fetch(`https://public-api.wordpress.com/rest/v1.1/sites/awesomeproject587944701.wordpress.com/posts/${blogId}`)
